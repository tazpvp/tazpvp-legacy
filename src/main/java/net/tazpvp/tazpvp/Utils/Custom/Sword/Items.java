...
public enum Items {
    ...
    private final char rarity; //c = common, u = uncommon, r = rare, e = epic, l = legendary
    ...
    Items(String name, Material material, int cost, int damage, int exp, char rarity, double cooldown, NamespacedKey key, PersistentDataType type, double storedID, List<Enchantment> enchantments, String... lore) {
        this.name = name;
        this.lore = lore;
