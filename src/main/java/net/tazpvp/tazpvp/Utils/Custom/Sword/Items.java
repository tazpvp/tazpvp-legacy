...
public enum Items {
    ...
    SteCut(ChatColor.WHITE + "Steel Cutlass", Material.STONE_SWORD, 6, ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 2, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "Looking for something durable?."),
    KeeDag(ChatColor.WHITE + "Keen Dagger", Material.STONE_SWORD, 6, ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 3, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "Basic but precise."),
    ...
    ShaCle(ChatColor.WHITE + "Sharp Cleaver", Material.STONE_SWORD, 7, ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 5, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "Best of the worst."),

    // uncommon swords
    HeaDulKni(ChatColor.GREEN + "Heavenly Dull Knife", Material.IRON_SWORD, 5, ChatColor.GREEN + "" + ChatColor.BOLD + "UNCOMMON", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 6, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "feels amazing in your hand but is quite dull."),
    ...
    DarShe(ChatColor.GREEN + "Darth Shear", Material.IRON_SWORD, 7, ChatColor.GREEN + "" + ChatColor.BOLD + "UNCOMMON", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 9, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "Am relic of the dark side."),
    ThoSti(ChatColor.GREEN + "Thorn Striker", Material.IRON_SWORD, 7, ChatColor.GREEN + "" + ChatColor.BOLD + "UNCOMMON", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 10, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "Those stricken feel unbearable pain."),
    ...
    // rare swords
    WinRip(ChatColor.AQUA + "Wind Ripper", Material.GOLDEN_SWORD, 8, ChatColor.AQUA + "" + ChatColor.BOLD + "RARE", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 12, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "Packed inside is the force of a hurricane."),
    WitBla(ChatColor.AQUA + "Withering Blade", Material.GOLDEN_SWORD, 7, ChatColor.AQUA + "" + ChatColor.BOLD + "RARE", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 13, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "The effects of such blade can be toxic."),
    ThuShoSwo(ChatColor.AQUA + "Thunderfury Short Sword", Material.GOLDEN_SWORD, 7, ChatColor.AQUA + "" + ChatColor.BOLD + "RARE", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 14, new HashMap<Enchantment, Integer>(), ChatColor.GRAY + "Only a master can wield such power."),
    StiCla(ChatColor.AQUA + "Stinger Claw", Material.GOLDEN_SWORD, 6, ChatColor.AQUA + "" + ChatColor.BOLD + "RARE", 0.625, PdcUtils.key, PersistentDataType.DOUBLE, 15, new HashMap<Enchantment, Integer>() {{
