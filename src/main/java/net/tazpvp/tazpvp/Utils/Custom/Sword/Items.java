...
public enum Items {
    // common swords
    WooKni(Material.STONE_SWORD, ChatColor.WHITE + "Kitchen Knife", ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 1, new HashMap<Enchantment, Integer>() {{ put(Enchantment.DAMAGE_ALL, 3); }} ),
    SteCut(Material.STONE_SWORD, ChatColor.WHITE + "Steel Cutlass", ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 2, new HashMap<Enchantment, Integer>() {{ put(Enchantment.DAMAGE_ALL, 4); }} ),
    KeeDag(Material.STONE_SWORD, ChatColor.WHITE + "Keen Dagger", ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 3, new HashMap<Enchantment, Integer>() {{ put(Enchantment.SWEEPING_EDGE, 1); put(Enchantment.DAMAGE_ALL, 3); }} ),
    PriSha(Material.STONE_SWORD, ChatColor.WHITE + "Prison Shank", ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 4, new HashMap<Enchantment, Integer>() {{ put(Enchantment.DAMAGE_ALL, 3); }}),
    ShaCle(Material.STONE_SWORD, ChatColor.WHITE + "Sharp Cleaver", ChatColor.WHITE + "" + ChatColor.BOLD + "COMMON", 5, new HashMap<Enchantment, Integer>() {{ put(Enchantment.SWEEPING_EDGE, 1); put(Enchantment.DAMAGE_ALL, 4); }} ),
    // uncommon swords
    HeaDulKni(Material.IRON_SWORD, ChatColor.GREEN + "Heavenly Dull Knife", ChatColor.GREEN + "" + ChatColor.BOLD + "UNCOMMON", 6, new HashMap<Enchantment, Integer>() {{ put(Enchantment.SWEEPING_EDGE, 2); put(Enchantment.DAMAGE_ALL, 1);}}),
    LigSteMac(Material.IRON_SWORD, ChatColor.GREEN + "Platinum Machete", ChatColor.GREEN + "" + ChatColor.BOLD + "UNCOMMON", 7, new HashMap<Enchantment, Integer>() {{ put(Enchantment.DAMAGE_ALL, 2); }}),
    GolSwiBla(Material.IRON_SWORD, ChatColor.GREEN + "Iron Switchblade", ChatColor.GREEN + "" + ChatColor.BOLD + "UNCOMMON", 8, new HashMap<Enchantment, Integer>() {{ put(Enchantment.DAMAGE_ALL, 1); }}),
    ...
    BlaOfVig(Material.DIAMOND_SWORD, ChatColor.LIGHT_PURPLE + "Blade of Vigor", ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "EPIC", 17, new HashMap<Enchantment, Integer>() {{put(Enchantment.SWEEPING_EDGE, 1); put(Enchantment.DAMAGE_ALL, 2); }}),
