...
// .longBitsToDouble(NumberUtils.doubleToLongBits(BIG_ENOUGH_INT + 1) - 1);
    ...
    public static byte randomByte(int max) {
        return (byte) new Random().nextInt(max + 1);
    }
    ...
    public static double offset(Entity a, Entity b) {
        return offset((Entity) a.getLocation().toVector(), (Entity) b.getLocation().toVector());
    }

    public static double offset(Location a, Location b) {
        return offset((Entity) a.toVector(), (Entity) b.toVector());
    }
